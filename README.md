...
- docs: added [docs/APP_ICONS.md](docs/APP_ICONS.md), a full catalogue of every app-icon asset in
  the repo — Android launcher, Play Store listing, web/PWA (including maskable), iOS, macOS,
  Windows, and Linux — with previews, exact pixel sizes, and which platforms are branded vs still
  shipping the stock Flutter logo (iOS, macOS, and Windows, per the gap first noted in
  [2026-08-15 (4)](#2026-08-15-4), which now also covers macOS/Windows). Linked from this section.

...
class TipsScreen extends ConsumerWidget {
  ...
  static const List<(String, String)> _tips = [
    ...
    (
      'Blackjack pays 3:2',
      'An ace plus a ten-card on the deal is a natural 21 — the best-paying hand in the game.',
    ),
    (
      'Win the sweep pot',
      "Every hand feeds the table's sweep pot. The best hand at the table takes the whole pot.",
    ),
    (
      'Never go broke',
      "Claim the daily bonus in the lobby and gift chips to friends — there's always a way back in.",
    ),
  ];
        ...
        children: [
          ...
          Positioned(
            ...
            child: Transform.rotate(
              ...
              child: Text('♣', style: TextStyle(fontSize: 220, height: 1, color: Colors.white.withValues(alpha: 0.03))),
            ),
          ),
          SafeArea(
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text('$number', style: AppText.mono(17, weight: FontWeight.w700, color: AppColors.gold)),
          ),
